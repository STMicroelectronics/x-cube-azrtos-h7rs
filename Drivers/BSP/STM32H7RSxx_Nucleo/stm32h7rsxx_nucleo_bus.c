/**
  ******************************************************************************
  * @file    stm32h7rsxx_nucleo_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32H7RS NUCLEO-144 board (MB1737) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
/* Includes ------------------------------------------------------------------*/
#include "stm32h7rsxx_nucleo_bus.h"
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS BUS
  * @{
  */

/** @defgroup STM32H7RSXX_NUCLEO_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Private_Types Private Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32H7RSXX_NUCLEO_BUS_Private_Constants
  * @{
  */
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
static void I2C3_MspInit(I2C_HandleTypeDef *phi2c);
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Exported_Functions Exported Functions
  * @{
  */
  ...
  if (I2c1InitCounter == 0U)
  {
    ...
    if (HAL_I2C_GetState(&hbus_i2c3) == HAL_I2C_STATE_RESET)
    {
      ...
      if (ret == BSP_ERROR_NONE)
      {
        ...
        if (MX_I2C3_Init(&hbus_i2c3, I2C_GetTiming(HAL_RCC_GetPCLK2Freq(), BUS_I2C3_FREQUENCY)) != HAL_OK)
        {
...
/** @defgroup STM32H7RSXX_NUCLEO_BUS_Private_Functions Private Functions
  * @{
  */
/**
...
{
  if (HAL_I2C_Mem_Write(&hbus_i2c3, DevAddr, Reg, MemAddSize, pData, Length, 1000) == HAL_OK)
  {
...
{
  if (HAL_I2C_Mem_Read(&hbus_i2c3, DevAddr, Reg, MemAddSize, pData, Length, 1000) == HAL_OK)
  {
    return BSP_ERROR_NONE;
  }
