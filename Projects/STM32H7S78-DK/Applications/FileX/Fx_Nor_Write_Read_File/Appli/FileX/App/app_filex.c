...
UCHAR media_memory[512] __attribute__ ((aligned (32)));
...
void fx_app_thread_entry(ULONG thread_input)
{
  ...
  printf("FileX/LevelX Custom NOR W25Q128J Application Start.\n");

  /* Print the absolute size of the NAND chip*/
  printf("Total NOR Flash Chip size is: %u bytes.\n", W25Q128J_FLASH_SIZE);
  ...
  status =  fx_media_format(&nor_flash_disk,
                            ...
                            0,                                          // Hidden sectors
                            W25Q128J_FLASH_SIZE / W25Q128J_SECTOR_SIZE, // Total sectors
                            512,                                        // Sector size
  ...
  status =  fx_media_open(&nor_flash_disk, "FX_LX_NOR_DISK", fx_stm32_levelx_nor_driver, (VOID*)CUSTOM_DRIVER_ID , media_memory, sizeof(media_memory));
