...
When an HID device is plugged to STM32H7S78-DK board, a message will be displayed on the UART HyperTerminal showing
...
When a USB flash disk is plugged to STM32H7S78-DK board, a message will be displayed on the UART HyperTerminal showing the Vendor ID and the Product ID of the attached device.
