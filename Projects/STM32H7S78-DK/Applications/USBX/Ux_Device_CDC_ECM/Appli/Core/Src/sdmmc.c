...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
  ...
  */
    ...
    PeriphClkInit.Sdmmc12ClockSelection = RCC_SDMMC12CLKSOURCE_PLL2T;
  ...
  /* Select SysClk as source of SDMMC clocks */
  RCC_PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_SDMMC12;
  RCC_PeriphClkInit.Sdmmc12ClockSelection = RCC_SDMMC12CLKSOURCE_PLL2S;
