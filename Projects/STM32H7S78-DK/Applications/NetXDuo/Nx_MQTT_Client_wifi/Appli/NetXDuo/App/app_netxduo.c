...
UINT MX_NetXDuo_Init(VOID *memory_ptr)
{
  ...
  ret = nx_ip_create(&IpInstance, "Main Ip instance", NULL_ADDRESS, NULL_ADDRESS, &NxAppPool, nx_driver_emw3080_entry,
  ...
  ret = tx_thread_create(&NxAppThread, "App Main thread", App_Main_Thread_Entry, 0, pointer, THREAD_MEMORY_SIZE,
...
static VOID App_SNTP_Thread_Entry(ULONG thread_input)
{
  ...
  ret =  nx_sntp_client_create(&SntpClient, &IpInstance, 0, &NxAppPool, NULL, NULL, NULL);
...
static VOID App_MQTT_Client_Thread_Entry(ULONG thread_input)
{
  ...
  ret = nxd_mqtt_client_create(&MqttClient, "my_client", CLIENT_ID_STRING, STRLEN(CLIENT_ID_STRING),
                               &IpInstance, &NxAppPool, (VOID*)mqtt_client_stack, MQTT_CLIENT_STACK_SIZE,
